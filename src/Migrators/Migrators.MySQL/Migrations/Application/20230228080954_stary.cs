...
{
    public partial class stary : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Owner = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    InactivityLimit = table.Column<TimeSpan>(type: "time(6)", nullable: false),
                    ...
                    FreeMargin = table.Column<double>(type: "double", nullable: false),
                    FreeMarginPercent = table.Column<double>(type: "double", nullable: false),
                    NotifyLevel = table.Column<double>(type: "double", nullable: false),
                    Profit = table.Column<double>(type: "double", nullable: false),
                    TradeCountMax = table.Column<uint>(type: "int unsigned", nullable: false),
                    TradeConfirmationTimeout = table.Column<TimeSpan>(type: "time(6)", nullable: false),
                    OrderPriority = table.Column<int>(type: "int", nullable: false),
                    OrderQuantityMinimum = table.Column<double>(type: "double", nullable: false),
                    OrderQuantityStep = table.Column<double>(type: "double", nullable: false),
                    OrderQuantityMaximum = table.Column<double>(type: "double", nullable: false),
                    MarginCalculationMode = table.Column<int>(type: "int", nullable: false),
                    MarginStopOutCalculationMode = table.Column<int>(type: "int", nullable: false),
                    MarginStopOutMode = table.Column<int>(type: "int", nullable: false),
                    MarginWarningPercent = table.Column<double>(type: "double", nullable: false),
                    MarginStopout = table.Column<double>(type: "double", nullable: false),
